...
import { facebookUrl, twitterUrl, gmailUrl, linkedinUrl } from '../Constants';
      ...
      <div className="flex flex-col max-w-2xl p-8 shadow-md rounded-lg bg-gray-300">
        ...
        <div className="flex flex-col mb-4">
          ...
          <div className="contact-item flex items-center mb-2">
            ...
            <span className="ml-2">Email: info@example.com</span>
          </div>
          <div className="contact-item flex items-center">
            <FaMapMarkerAlt className="text-xl" />
            <span className="ml-2">Address: 123 Street, City, Country</span>
          </div>
        </div>
      </div>
